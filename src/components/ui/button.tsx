  ...
  "inline-flex items-center justify-center gap-3 whitespace-nowrap rounded-xl text-base font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // MedGuard specific variants
        scan: "bg-primary text-primary-foreground shadow-medium hover:shadow-lg hover:bg-primary/90 active:scale-[0.98] text-lg",
        safe: "bg-safe text-safe-foreground hover:bg-safe/90 shadow-soft",
        caution: "bg-caution text-caution-foreground hover:bg-caution/90 shadow-soft",
